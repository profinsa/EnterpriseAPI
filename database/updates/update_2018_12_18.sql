...
-- Stored procedure definition script WarehouseBinShipGoods2 for MySQL
-- Generated by (c) Ispirer SQLWays 4.0 Build 219 Licensed to STFB
-- Timestamp: Tue Jul 28 16:20:00 2015

DELIMITER //
DROP PROCEDURE IF EXISTS WarehouseBinShipGoods2;
//
...
/*
Name of stored procedure: WarehouseBinShipGoods
Method: 
...
Input Parameters:
	...
	@BackOrderQty FLOAT		 - the count of backordered items
	@Action INT			 - defines the operation that is performed with inventory items 

                                                           1 - decrease InventoryByWarehouse.QtyCommitted in @Qty value and increase in @BackOrderQty value
                                                               decrease WarehouseBins.LockerStockQty in @Qty value and increase in @BackOrderQty value
                                                               used from Invoice_AdjustInventory, ReturnInvoice_AdjustInventory procedures

							   2 - reverse relative to 1 operation
                                                               increase InventoryByWarehouse.QtyCommitted in @Qty value and decrease in @BackOrderQty value
                                                               increase WarehouseBins.LockerStockQty in @Qty value and decrease in @BackOrderQty value
                                                               used from Invoice_UndoAdjustInventory procedure

							   3 - decrease InventoryByWarehouse.QtyOnHand in @Qty 
                                                               used from Inventory_Assemblies,Inventory_Transfer,InventoryAdjustments_Post procedures

							   4 - reverse relative to 3 operation 
                                                               increase InventoryByWarehouse.QtyOnHand in @Qty
                                                               used from InventoryAdjustments_Cancel procedure
...
Called From:
	...
	InventoryAdjustments_Post, InventoryAdjustments_Cancel, Inventory_Assemblies, Inventory_Transfer, Invoice_AdjustInventory, Invoice_UndoAdjustInventory, ReturnInvoice_AdjustInventory
