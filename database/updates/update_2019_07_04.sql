...
-- get the RMA number as a new number from the company table    
   SET @SWV_Error = 0;
   SET v_NextNumber = LEFT(v_NewInvoiceNumber, 36);
   CALL GetNextEntityID2(v_CompanyID,v_DivisionID,v_DepartmentID,'NextInvoiceNumber',v_NextNumber, v_ReturnStatus);      SET v_NewInvoiceNumber = v_NextNumber;
