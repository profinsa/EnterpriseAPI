...
-- Stored procedure definition script Invoice_CopyAllToHistory for MySQL
-- Generated by (c) Ispirer SQLWays 4.0 Build 219 Licensed to STFB
-- Timestamp: Tue Jul 28 16:20:00 2015

DELIMITER //
DROP PROCEDURE IF EXISTS Invoice_CopyAllToHistory;
//
...
/*
Name of stored procedure: Invoice_CopyAllToHistory
Method: 
	Moves all invoices to history table
...
Called From:
	...
	Invoice_CopyAllToHistory.vb

Calls:

	Invoice_CopyToHistory, Error_InsertError, Error_InsertErrorDetail
