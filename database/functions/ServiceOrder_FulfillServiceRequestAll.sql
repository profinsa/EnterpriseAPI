CREATE FUNCTION ServiceOrder_FulfillServiceRequestAll (v_CompanyID 	NATIONAL VARCHAR(36),
   ...
   IF @SWV_Error <> 0 then
      ...
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'ServiceOrder_FulfillServiceRequesAll',
