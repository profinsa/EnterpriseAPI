CREATE FUNCTION Payroll_Agi_Create_Detail_One (v_CompanyID NATIONAL VARCHAR(36),
...
VALUES(v_CompanyID,
   ...
   IF v_Basis = UPPER('AGI') then
      ...
      IF v_ReturnStatus <> 0 OR @SWV_Error <> 0 then
         ...
         CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Payroll_Agi_Create_Detail_One',
