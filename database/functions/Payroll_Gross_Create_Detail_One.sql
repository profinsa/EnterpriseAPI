CREATE FUNCTION Payroll_Gross_Create_Detail_One (v_CompanyID NATIONAL VARCHAR(36),
...
VALUES(v_CompanyID,
   ...
   IF v_Basis = UPPER('Gross') then
      ...
      IF v_ReturnStatus <> 0 OR @SWV_Error <> 0 then
         ...
         CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Payroll_Gross_Create_Detail_One',
