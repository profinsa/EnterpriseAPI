CREATE PROCEDURE RptGLIncomeStatementRangeComparative (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   CALL Error_InsertError(v_CompanyID,v_DepartmentID,v_DivisionID,'RptGLIncomeStatementComparative',
