CREATE PROCEDURE ReturnReceipt_CreateFromInvoice2 (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then
      ...
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'ReturnReceipt_CreateFromInvoice',
   ...
   v_CompanyID,
		...
		v_DepartmentID,
		v_ReceiptID,
		IFNULL(PaymentMethodID,'Receipt'),
		CheckNumber,
		CustomerID,
		SystemDate,
		CurrencyID,
