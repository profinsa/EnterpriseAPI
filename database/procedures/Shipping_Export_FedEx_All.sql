CREATE PROCEDURE Shipping_Export_FedEx_All (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   IF v_OLEResult <> 0 then
      ...
      CALL Error_InsertError('DEFAULT','DEFAULT','DEFAULT','Shipping_Export_FedEx',v_ErrorMessage,v_ErrorID);
      SET SWP_Ret_Value = -1;
      LEAVE SWL_return;
   end if;	
