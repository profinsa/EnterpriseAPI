CREATE PROCEDURE Invoice_UndoAdjustInventory2 (v_CompanyID NATIONAL VARCHAR(36), 
...
BEGIN
   ...
   IF v_ReturnStatus = -1 then
      ...
      ROLLBACK;
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Invoice_UndoAdjustInventory',
   ...
   WHILE NO_DATA = 0 DO
      ...
      SET @SWV_Error = 0;
      SET v_ReturnStatus = WarehouseBinShipGoods(v_CompanyID,v_DivisionID,v_DepartmentID,v_WarehouseID,v_WarehouseBinID,
      v_ItemID,v_OrderQty,v_BackOrderQty,2);
