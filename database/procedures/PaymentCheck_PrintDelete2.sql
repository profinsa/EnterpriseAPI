CREATE PROCEDURE PaymentCheck_PrintDelete2 (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   IF @SWV_Error <> 0 then
      ...
      CALL Error_InsertError(v_CompanyID,'','','PaymentCheck_PrintDelete',v_ErrorMessage,v_ErrorID);
