CREATE PROCEDURE Inventory_PopulatePOSPrice (v_CompanyID NATIONAL VARCHAR(36),
   ...
   select   IFNULL(UsePricingCodes,0), UseCustomerSpecificPricing, DefaultPricingCode INTO v_UsePricingCode,v_UseCustomerSpecificPricing,v_DefaultPricingCode FROM POSSetup WHERE
