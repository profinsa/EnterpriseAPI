CREATE PROCEDURE JointPayment_ApproveAll (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   OR DivisionID <> v_DivisionID
   OR DepartmentID <> v_DepartmentID)
   ...
   IF @SWV_Error <> 0 then
      ...
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'JointPayment_Approve',v_ErrorMessage,
      v_ErrorID);
