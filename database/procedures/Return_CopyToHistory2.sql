CREATE PROCEDURE Return_CopyToHistory2 (v_CompanyID 	NATIONAL VARCHAR(36),
...
BEGIN
   ...
   AND LOWER(IFNULL(TransactionTypeID,N'')) = LOWER('Return');
   ...
   AND OrderNumber = v_OrderNumber) then
      ...
      IF @SWV_Error <> 0 then
         ...
         ROLLBACK;
         CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Return_CopyToHistory',v_ErrorMessage,
         v_ErrorID);
