CREATE PROCEDURE WorkOrderInventory_CopyToHistory2 (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   AND WorkOrderNumber = v_WorkOrderNumber) then
      ...
      IF @SWV_Error <> 0 then
         ...
         CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'WorkOrderInventory_CopyToHistory',
