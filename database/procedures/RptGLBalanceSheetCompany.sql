CREATE PROCEDURE RptGLBalanceSheetCompany (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   IF v_ReturnStatus = -1 then
      ...
      CALL Error_InsertError(v_CompanyID,v_DepartmentID,v_DivisionID,'RptGLBalanceSheetCompany',v_ErrorMessage,
      v_ErrorID);
      SET SWP_Ret_Value = -1;
   end if;
