CREATE PROCEDURE RptGLAgedPayablesDetailYTD (v_CompanyID NATIONAL VARCHAR(36),
   ...
   VendorID,
	...
	cast(fnRound(v_CompanyID,v_DivisionID,v_DepartmentID,SUM(YTD),v_CompanyCurrencyID) as SIGNED INTEGER) AS YTD
   FROM
   tt_Result
   GROUP BY
   VendorID,VendorName;
