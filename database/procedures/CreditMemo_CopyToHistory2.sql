CREATE PROCEDURE CreditMemo_CopyToHistory2 (v_CompanyID 	NATIONAL VARCHAR(36),
...
BEGIN
   ...
   AND LOWER(IFNULL(TransactionTypeID,N'')) = 'credit memo') then
   ...
   IF (v_Work = 0) then
      ...
      IF @SWV_Error <> 0 then
         ...
         ROLLBACK;
         CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'CreditMemo_CopyToHistory',v_ErrorMessage,
         v_ErrorID);
