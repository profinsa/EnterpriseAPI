CREATE PROCEDURE Invoice_CreateFromServiceOrder (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then
      ...
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Invoice_CreateFromServiceOrder',
   ...
   SET @SWV_Error = 0;
   SET v_ReturnStatus = ServiceInvoice_Post(v_CompanyID,v_DivisionID,v_DepartmentID,v_InvoiceNumber);
   IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then
