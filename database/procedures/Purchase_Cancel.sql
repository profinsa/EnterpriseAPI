CREATE PROCEDURE Purchase_Cancel (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   IF @SWV_Error <> 0 then
      ...
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Purchase_Cancel',v_ErrorMessage,
      v_ErrorID);
   ...
   SET @SWV_Error = 0;
   SET v_ReturnStatus = Inventory_GetWarehouseForPurchase(v_CompanyID,v_DivisionID,v_DepartmentID,v_PurchaseNumber,v_OrderWarehouseID);
   ...
   WHILE NO_DATA = 0 DO
      ...
      IF v_Received = 0 then
         ...
         SET @SWV_Error = 0;
         SET v_ReturnStatus = WarehouseBinPutGoods(v_CompanyID,v_DivisionID,v_DepartmentID,v_DetailWarehouseID,v_WarehouseBinID,
         v_ItemID,NULL,NULL,NULL,NULL,v_OrderQty,3,v_IsOverflow);
         IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then
      ...
      ELSE
         SET @SWV_Error = 0;
         SET v_ReturnStatus = WarehouseBinPutGoods(v_CompanyID,v_DivisionID,v_DepartmentID,v_DetailWarehouseID,v_WarehouseBinID,
         v_ItemID,NULL,NULL,NULL,NULL,v_OrderQty,4,v_IsOverflow);
         IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then
