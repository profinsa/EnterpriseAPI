CREATE PROCEDURE PayrollEmployeesTaskDetailSelect (v_CompanyID NATIONAL VARCHAR(36), v_DivisionID NATIONAL VARCHAR(36), v_DepartmentID NATIONAL VARCHAR(36), v_EmployeeID NATIONAL VARCHAR(36), v_EmployeeTaskID NATIONAL VARCHAR(36), v_EmployeeTaskDetailID NATIONAL VARCHAR(36)) begin
   SELECT
   EmployeeTaskID,
