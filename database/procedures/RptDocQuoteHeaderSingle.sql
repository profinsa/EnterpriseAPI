CREATE PROCEDURE RptDocQuoteHeaderSingle (v_CompanyID NATIONAL VARCHAR(36), 
 ...
 v_OrderNumber NATIONAL VARCHAR(36)) BEGIN
   ...
   WHERE OrderHeader.CompanyID = v_CompanyID and OrderHeader.DivisionID = v_DivisionID and OrderHeader.DepartmentID = v_DepartmentID and OrderHeader.OrderNumber = v_OrderNumber and OrderHeader.OrderTypeID = 'Quote';
END