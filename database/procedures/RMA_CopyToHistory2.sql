CREATE PROCEDURE RMA_CopyToHistory2 (v_CompanyID 	NATIONAL VARCHAR(36),
...
BEGIN
   ...
   IF ROW_COUNT() = 0 then
      ...
      set v_PostingResult = N'RMA is not paid yet';
      SET SWP_Ret_Value = -2;
      LEAVE SWL_return;
   end if;
   ...
   AND PurchaseNumber = v_PurchaseNumber) then
      ...
      IF @SWV_Error <> 0 then
         ...
         CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'RMA_CopyToHistory',v_ErrorMessage,
         v_ErrorID);
