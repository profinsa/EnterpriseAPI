CREATE PROCEDURE SerialNumber_Cancel2 (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   SET
   CurrentLotOrderQty = CurrentLotOrderQty+v_OrderQty
   WHERE
   ...
   IF @SWV_Error <> 0 OR ROW_COUNT() <> 1 then
      ...
      ROLLBACK;
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'SerialNumber_Cancel',v_ErrorMessage,
      v_ErrorID);
