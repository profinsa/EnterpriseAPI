CREATE PROCEDURE Return_MakeInvoiceReceipt (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   IF @SWV_Error <> 0 OR v_ReturnStatus = -1 OR v_InvoiceNumber = N'' then
      ...
      ROLLBACK;
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Return_MakeInvoiceReceipt',v_ErrorMessage,
      v_ErrorID);
