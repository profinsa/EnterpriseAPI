CREATE PROCEDURE ServiceInvoice_CopyToHistory2 (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   AND LOWER(IFNULL(TransactionTypeID,N'')) = LOWER('Service Invoice');
   IF ROW_COUNT() = 0 then
   ...
   AND InvoiceNumber = v_InvoiceNumber) then
      ...
      IF @SWV_Error <> 0 then
         ...
         CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'ServiceInvoice_CopyToHistory',
