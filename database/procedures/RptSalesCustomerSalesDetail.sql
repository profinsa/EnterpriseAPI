CREATE PROCEDURE RptSalesCustomerSalesDetail (v_CompanyID NATIONAL VARCHAR(36),
   ...
   CustomerInformation.CustomerID,
	...
	InvoiceHeader.InvoiceNumber as InvoiceNumber,
   ...
   GROUP BY
   CustomerInformation.CustomerID,CustomerInformation.CustomerName,InvoiceHeader.InvoiceNumber;
