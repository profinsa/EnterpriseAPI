CREATE PROCEDURE WorkOrderInternal_CreateFromMemorized (v_CompanyID NATIONAL VARCHAR(36),
	v_DivisionID NATIONAL VARCHAR(36),
	v_DepartmentID NATIONAL VARCHAR(36),
	v_WorkOrderNumber NATIONAL VARCHAR(36),
	INOUT v_NewWorkOrderNumber NATIONAL VARCHAR(36),INOUT SWP_Ret_Value INT) SWL_return:
BEGIN
   ...
   IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then
      ...
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'WorkOrderInternal_CreateFromMemorized',
