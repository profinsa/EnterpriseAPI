CREATE PROCEDURE RptGLBalanceSheet (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   SELECT
   GLBalanceType, GLAccountName, fnRound(v_CompanyID,v_DivisionID,v_DepartmentID,GLAccountBalance,N'') AS GLAccountBalance
   FROM
