CREATE PROCEDURE RptJointCheck (v_CompanyID NATIONAL VARCHAR(36),
   ...
   Companies.CompanyName,
	...
	IFNULL((SELECT
      ...
      PaymentChecks
      WHERE
			(PaymentChecks.CompanyID <> v_CompanyID OR
      PaymentChecks.DivisionID <> v_DivisionID OR
   ...
   WHERE
	(PC.CompanyID <> v_CompanyID OR
   PC.DivisionID <> v_DivisionID OR
