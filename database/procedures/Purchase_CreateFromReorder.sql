CREATE PROCEDURE Purchase_CreateFromReorder (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   InventoryByWarehouse.QtyOnHand <= InventoryItems.ReOrderLevel;
   ...
   WHILE NO_DATA <> 0 DO
      ...
      IF (v_PurchaseHasDetails = 1) then
         ...
         IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then
            ...
            CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Purchase_CreateFromReorder',v_ErrorMessage,
            v_ErrorID);
            SET SWP_Ret_Value = -1;
         end if;
      end if;
      ...
      SET NO_DATA = 0;
      FETCH cItemsForVendor INTO v_ItemID,v_WarehouseID,v_WarehouseBinID,v_ReOrderQty,v_ItemUOM,v_ItemWeight, 
      v_IsAssembly;
      WHILE NO_DATA <> 0 DO
         ...
         IF (v_IsAssembly = 1) then
            ...
            SET @SWV_Error = 0;
            SET v_ReturnStatus = Order_CreateAssembly2(v_CompanyID,v_DivisionID,v_DepartmentID,v_ItemID,v_ReOrderQty,v_Result);
         ...
         IF (v_AssemblyCreated = 0) then
            ...
            v_ItemID,NULL,NULL,NULL,NULL,v_ReOrderQty,1,v_IsOverflow);
            IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then
