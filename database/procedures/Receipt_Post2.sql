...
BEGIN
   ...
   START TRANSACTION;
   SET @SWV_Error = 0;
   SET v_ReturnStatus = Receipt_Recalc(v_CompanyID,v_DivisionID,v_DepartmentID,v_ReceiptID);
   ...
   SET @SWV_Error = 0;
   SET v_ReturnStatus = Receipt_CreateGLTransaction2(v_CompanyID,v_DivisionID,v_DepartmentID,v_ReceiptID);
   IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then
