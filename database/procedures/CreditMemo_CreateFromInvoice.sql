CREATE PROCEDURE CreditMemo_CreateFromInvoice (v_CompanyID NATIONAL VARCHAR(36), 
...
BEGIN
   ...
   IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then
      ...
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'CreditMemo_CreateFromInvoice',
