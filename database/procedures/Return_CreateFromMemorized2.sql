CREATE PROCEDURE Return_CreateFromMemorized2 (v_CompanyID  NATIONAL VARCHAR(36),    
...
BEGIN
   ...
   IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then    
      ...
      ROLLBACK;
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Return_CreateFromMemorized',v_ErrorMessage,
      v_ErrorID);
 ...
 ManagerPassword
   ...
   IF @SWV_Error <> 0 then    
      ...
      SET v_ErrorMessage = 'Insert into OrderHeader failed';
      ROLLBACK;
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Return_CreateFromMemorized',v_ErrorMessage,
      v_ErrorID);
      CALL Error_InsertErrorDetail(v_CompanyID,v_DivisionID,v_DepartmentID,v_ErrorID,'OrderNumber',v_OrderNumber);
 ...
 SubTotal
   ...
   Set v_NewOrderNumber = CONCAT('New Return Order Created With Order Number:',v_NewOrderNumber);    
