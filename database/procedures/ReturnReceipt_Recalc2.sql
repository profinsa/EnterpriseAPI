CREATE PROCEDURE ReturnReceipt_Recalc2 (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   IF @SWV_Error <> 0 then
      ...
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'ReturnReceipt_Recalc',v_ErrorMessage,
      v_ErrorID);
