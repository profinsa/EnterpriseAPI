CREATE PROCEDURE CreditMemo_CreateFromMemorized (v_CompanyID  NATIONAL VARCHAR(36),      
...
BEGIN
   ...
   IF @SWV_Error <> 0 OR v_ReturnStatus = -1 then
      ...
      ROLLBACK;
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'CreditMemo_CreateFromMemorized',
 ...
 SubTotal
   ...
   SET v_NewInvoiceNumber = CONCAT('New Credit Memo Created With Credit Memo Number:',v_NewInvoiceNumber);      
