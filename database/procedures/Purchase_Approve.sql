CREATE PROCEDURE Purchase_Approve (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   IF @SWV_Error <> 0 OR ROW_COUNT() <> 1 then
      ...
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Purchase_Approve','',v_ErrorID);
      SET SWP_Ret_Value = -1;
   end if;
