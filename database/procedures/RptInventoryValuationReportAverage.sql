CREATE PROCEDURE RptInventoryValuationReportAverage (v_CompanyID NATIONAL VARCHAR(36),
   ...
   InventoryItems.ItemID,
	...
	fnRound(v_CompanyID,v_DivisionID,v_DepartmentID,AverageValue*QtyOnHand,v_CompanyCurrencyID)  AS Valuation 
   FROM
