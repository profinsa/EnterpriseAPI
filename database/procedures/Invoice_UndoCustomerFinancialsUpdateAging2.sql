CREATE PROCEDURE Invoice_UndoCustomerFinancialsUpdateAging2 (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   IF v_AgeInvoicesBy = N'1' then
      ...
      select   InvoiceDate, PostedDate INTO v_DateToAgeBy,v_PostedDate FROM
      InvoiceHeader WHERE
   ...
   SET v_position = TIMESTAMPDIFF(DAY,v_DateToAgeBy,v_PostedDate);
   ...
   IF @SWV_Error <> 0 then
      ...
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'Invoice_UndoCustomerFinancialsUpdateAging',
