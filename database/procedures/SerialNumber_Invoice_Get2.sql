CREATE PROCEDURE SerialNumber_Invoice_Get2 (v_CompanyID NATIONAL VARCHAR(36),
	...
	v_InvoiceLineNumber SMALLINT,INOUT SWP_Ret_Value INT) SWL_return:
BEGIN
   ...
   SET
   InvoiceNumber = v_InvoiceNumber,InvoiceLineNumber = v_InvoiceLineNumber
   WHERE
   ...
   IF @SWV_Error <> 0 OR ROW_COUNT() <> 1 then
      ...
      ROLLBACK;
      CALL Error_InsertError(v_CompanyID,v_DivisionID,v_DepartmentID,'SerialNumber_Invoice_Get',v_ErrorMessage,
      v_ErrorID);
