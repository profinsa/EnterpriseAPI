CREATE PROCEDURE RptGLIncomeStatementRangeYTD (v_CompanyID NATIONAL VARCHAR(36),
...
BEGIN
   ...
   CALL Error_InsertError(v_CompanyID,v_DepartmentID,v_DivisionID,'RptGLIncomeStatementYTD',v_ErrorMessage,
   v_ErrorID);
