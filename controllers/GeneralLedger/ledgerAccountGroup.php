<?php
/*
Name of Page: ledgerAccountGroup

Method: controller of GeneralLedger/ledgerAccountGroup page, used for rendering page and interacting with it
...
class controller{
    ...
    public function process($app){
        ...
        $data = new ledgerAccountGroup($app->db);
