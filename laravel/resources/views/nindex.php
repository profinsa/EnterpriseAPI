...
<html>
	...
	<script type="text/javascript" src="<?php echo $public_prefix; ?>/assets/js/espo.min.js" data-base-path=""></script><script src="chrome-extension://mclbjdibcpiohnhgkjkbfbnjcafkhani/files/foreground.js"></script>
	...
	<style type="text/css" data-gs-id="gridstack-style-75547"></style>
 ...
 /*   $menuCategories[$translation->translateLabel('Receivables')] = [
    ...
    $menuCategories[$translation->translateLabel('Log out')] = [
	"type" => "item",
	"data" => [
