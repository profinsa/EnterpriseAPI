                        ...
                        if($item["type"] == "absoluteLink")
                            ...
                            foreach($item["data"] as $key=>$subitem){
                                if(!key_exists("type", $subitem))
                                    ...
                                    echo "<li id=\"" . ( key_exists("id", $subitem) ? $subitem["id"] : "") . "\"><a href=\"" . $subitem["href"] . "\" " . (key_exists("target", $subitem) ? "target=\"" . $subitem["target"] . "\"" : "") . ">" . $subitem["full"] . "</a></li>";                    
                            ...
                            echo "<li id=\"list" . $item["id"] . "\"><a href=\"\" class=\"waves-effect\" onclick=\"accessDeniedMessage(event);\"><i class=\"icon-" . (key_exists("icon", $item) ? $item["icon"] : "people"). " fa-fw\"></i> <span class=\"hide-menu\">" . $item["full"] . "<span class=\"fa arrow\"></span></span></a></li>";
