...
<nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header"> 
        ...
        <ul class="nav navbar-top-links <?php echo ($ascope["interfaceType"] == "ltr" ? "navbar-right pull-right" : "navbar-left pull-left") ; ?>" dir="<?php echo $ascope["interfaceType"] ?>">
            ...
            <li style="right:-3px;">
                <div class="dropdown" style="margin-top:13px; margin-right:0px;">
                    <button class="btn btn-default dropdown-toggle" type="button" id="helpDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:white; margin-top:2px; border:0px; background-color:inherit;">
