<a class="btn btn-info" href="javascript:;" onclick="callRecalc('<?php echo $headerItem["ReceiptID"]; ?>')">
    <?php
	echo $translation->translateLabel("Recalc");
    ?>
</a>
<?php if(!$headerItem["Posted"]): ?>
    <a class="btn btn-info" href="javascript:;" onclick="serverProcedureCall('Post', { ReceiptID : '<?php echo $headerItem["ReceiptID"]; ?>'}, true);">
	<?php
