...
<div id="row_viewer">
	...
	$customer = $data->getCustomerInfo($scope->item, "Main");
	...
	<div class="col-md-6 col-xs-6" style="margin-top:20px;">
		...
		<tbody id="row_viewer_tbody">
		    ...
		    echo  "<tr><td><b>" . $translation->translateLabel($data->columnNames["CustomerID"]) . "</b></td><td><b>" . $customer["CustomerID"] . "</b></td>";
		    echo  "<tr><td><b>" . $translation->translateLabel($data->columnNames["CustomerName"]) . "</b></td><td><b>" . $customer["CustomerName"] . "</b></td>";
		    echo  "<tr><td>" . $translation->translateLabel($data->columnNames["CustomerPhone"]) . "</td><td>" . $customer["CustomerPhone"] . "</td>";
		    echo  "<tr><td>" . $translation->translateLabel($data->columnNames["CustomerEmail"]) . "</td><td><a href=\"mailto:{$customer["CustomerEmail"]}\">{$customer["CustomerEmail"]}</a></td>";
		    echo  "<tr><td><b>" . $translation->translateLabel($data->columnNames["AvailibleCredit"]) . "</b></td><td><b>" . getRowValue($scope, $data, "AvailibleCredit", $finitem["AvailibleCredit"]) . "</b></td>";
		    ?>
		</tbody>
	    </table>
	</div>
