...
<a href="javascript:;" onclick="serverProcedureCall('releaseOnHoldOrder', { OrderNumber : '<?php echo $row["OrderNumber"];?>'}, true);" data-toggle="tooltip" title="Release Order On Hold">
    <span class="grid-action-button glyphicon glyphicon-list" aria-hidden="true"></span>
</a>
