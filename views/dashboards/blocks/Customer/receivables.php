...
?>
<div class="white-box">
    <h3 class="box-title m-b-0"><?php echo $translation->translateLabel("Receivables"); ?></h3>
    <div id="customer-receivables-chart" class="ecomm-donute" style="height: 317px;"></div>
	...
	<?php
	    ...
	    foreach($customerReceivables as $row)
...
<script> 
 Morris.Donut({
     element: 'customer-receivables-chart',
     data: [
         <?php
             foreach($customerReceivables as $row)
