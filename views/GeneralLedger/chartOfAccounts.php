		...
		<div class="white-box">
			...
			<div id="grid_content" class="row">
				...
				<table id="example23" class="table table-striped">
					...
					<?php
					foreach($rows as $row){
					    echo "<tr><td><a href=\"index.php?page=GeneralLedger/chartOfAccounts&mode=view&category=Main&item=" . $row["GLAccountNumber"] ."\"><span class=\"grid-action-button glyphicon glyphicon-edit\" aria-hidden=\"true\"></span></a><span onclick=\"deleteItem('" . $row["GLAccountNumber"] . "')\" class=\"grid-action-button glyphicon glyphicon-remove\" aria-hidden=\"true\"></span></td>";
