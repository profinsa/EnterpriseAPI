				...
				<div id="grid_content" class="row">
					...
					<table id="example23" class="table table-striped">
						...
						foreach($rows as $row){
							...
							echo "<a href=\"index.php?page=" . $app->page . "&mode=view&category=Main&item=" . $row["GLAccountNumber"] ."\"><span class=\"grid-action-button glyphicon glyphicon-edit\" aria-hidden=\"true\"></span></a>";
				    ...
				    <script>
					 ...
					 if(confirm("Are you sure?")){
					     ...
					     $.getJSON("index.php?page=<?php  echo $app->page; ?>&delete=true&GLAccountNumber=" + item)
