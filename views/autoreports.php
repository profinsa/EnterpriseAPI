<div class="container-fluid">
   ...
   // require __DIR__ . '/format.php';
	...
	<div class="col-md-12">
	    <a id="getreportexplorer" class="btn btn-info" href="index.php?page=autoreports&getreport=<?php echo $reportName; ?>?type=explorer&title=<?php echo $_GET["title"]; ?>" target="_blank">Reports Explorer</a>
	    <a id="getreportscreen" class="btn btn-info" href="index.php?page=autoreports&getreport=<?php echo $reportName; ?>?type=screen&title=<?php echo $_GET["title"]; ?>" target="_blank">Screen</a>
	    <a id="getreportpdf" class="btn btn-info" href="index.php?page=autoreports&getreport=<?php echo $reportName; ?>?type=pdf&title=<?php echo $_GET["title"]; ?>" target="_blank">PDF</a>
	    <a id="getreporttext"  class="btn btn-info" href="index.php?page=autoreports&getreport=<?php echo $reportName; ?>?type=text&title=<?php echo $_GET["title"]; ?>" target="_blank">CSV</a>
	    <a id="getreportexcel" class="btn btn-info" href="index.php?page=autoreports&getreport=<?php echo $reportName; ?>?type=excel&title=<?php echo $_GET["title"]; ?>" target="_blank">Excel</a>
	    <a id="getreportcopy" class="btn btn-info" href="index.php?page=autoreports&getreport=<?php echo $reportName; ?>?type=copy&title=<?php echo $_GET["title"]; ?>" target="_blank">Copy</a>
	    <a id="getreportchart" class="btn btn-info" href="index.php?page=autoreports&getreport=<?php echo $reportName; ?>?type=chart&title=<?php echo $_GET["title"]; ?>" target="_blank">Chart</a>
	</div>
	<script>
