        ...
        [
             ...
             "data" => [
                 [
                     ...
                     "href" => "https://www.stfb.net/EnterpriseXCart/index.php?loadusername=dland&loadpassword=dland&CompanyID={$user["CompanyID"]}&DivisionID={$user["DivisionID"]}&DepartmentID={$user["DepartmentID"]}"
                 ],
		    [
			"type" => "submenu",
