...
class EDIOrderHeaderList extends gridDataSource{
	public $tableName = "ediorderheader";
	public $dashboardTitle ="EDI Orders";
	public $breadCrumbTitle ="EDI Orders";
    ...
    public $detailTable = [
        "viewPath" => "SystemSetup/EDISetup/OrderDetail",
    ...
    public function getDetail($id){
        ...
        $result = DB::select("SELECT " . implode(",", $fields) . " from ediorderdetail " .  ( $keyFields != "" ? " WHERE ". $keyFields : ""), array());
    ...
    public function detailDelete(){
        ...
        DB::delete("DELETE from ediorderdetail " .   ( $keyFields != "" ? " WHERE ". $keyFields : ""));
    }
}
?>
