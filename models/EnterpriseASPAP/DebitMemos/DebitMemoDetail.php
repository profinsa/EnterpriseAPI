<?php
/*
  Name of Page: Debit Memo Detail model

  Method: Model for Debit Memo Detail form. It provides data from database and default values, column names and categories

  Date created: 05/19/2017 Zaharov Nikita

  Use: this model used by views/gridView  - as a dictionary for view during building interface(tabs and them names, fields and them names etc, column name and corresponding translationid)
...
class gridData extends gridDataSource{
	...
	public $dashboardTitle = "Debit Memo Detail";
	public $breadCrumbTitle = "Debit Memo Detail";
