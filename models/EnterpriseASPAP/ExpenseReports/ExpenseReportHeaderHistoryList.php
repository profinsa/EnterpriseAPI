...
class ExpenseReportHeaderHistoryList extends gridDataSource{
    public $tableName = "expensereportheaderhistory";
    ...
    public $detailPages = [
        "Expense Report Detail" => [
            "disableNew" => "true",
            "hideFields" => "true",
            "viewPath" => "Payroll/EmployeeExpenses/ExpenseReportsHistoryDetail",
    ...
    public function getExpenseReportDetail($id){
        ...
        $result = DB::select("SELECT " . implode(",", $fields) . " from expensereportdetailhistory " .  ( $keyFields != "" ? " WHERE ". $keyFields : ""), array());
    ...
    public function deleteExpenseReportDetaill(){
        $user = Session::get("user");
        ...
        DB::delete("DELETE from expensereportdetailhistory " .   ( $keyFields != "" ? " WHERE ". $keyFields : ""));
    }
}
?>
