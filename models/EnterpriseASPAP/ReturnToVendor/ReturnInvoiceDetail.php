<?php
/*
  Name of Page: Return Invoice Detail model

  Method: Model for Return Invoice Detail form. It provides data from database and default values, column names and categories
