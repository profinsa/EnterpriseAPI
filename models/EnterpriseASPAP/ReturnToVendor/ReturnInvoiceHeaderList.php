<?php
/*
  Name of Page: Return Invoice Header model

  Method: Model for AP/ReturnToVendor/View Invoices
...
class ReturnInvoiceHeaderClosedList extends ReturnInvoiceHeaderList{
    ...
    public function CopyToHistory(){
        ...
        foreach($numbers as $number){
            DB::statement("CALL ReturnInvoice_CopyToHistory2('" . $user["CompanyID"] . "','" . $user["DivisionID"] . "','" . $user["DepartmentID"] . "','" . $number . "',@SWP_RET_VALUE)");
    ...
    public function CopyAllToHistory(){
        ...
        DB::statement("CALL ReturnInvoice_CopyAllToHistory('" . $user["CompanyID"] . "','" . $user["DivisionID"] . "','" . $user["DepartmentID"] . "', @SWP_RET_VALUE)");
