<?php
/*
  Name of Page: Return Header model

  Method: Model for AP/ReturnToVendor/View Returns, Pick&Pack, Ship, Invoice
...
class ReturnHeaderShipList extends ReturnHeaderList{
    ...
    public $breadCrumbTitle ="Ship Returns";
...
class ReturnHeaderInvoiceList extends ReturnHeaderList {
    ...
    public function ReturnInvoice_CreateFromReturn(){
        ...
        $success = true;
        foreach($numbers as $number){
            DB::statement("CALL ReturnInvoice_CreateFromReturn2('" . $user["CompanyID"] . "','" . $user["DivisionID"] . "','" . $user["DepartmentID"] . "','" . $number . "',@v_InvoiceNumber ,@SWP_RET_VALUE)");
