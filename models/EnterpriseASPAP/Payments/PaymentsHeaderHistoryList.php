...
/*
  ...
   
  Method: Model for www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAP\Payments\PaymentsHeaderHistoryList.php It provides data from database and default values, column names and categories
   
  ...
   
  Called from:
  created and used for ajax requests by controllers/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAP\Payments\PaymentsHeaderHistoryList.php
  used as model by views/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAP\Payments\PaymentsHeaderHistoryList.php
   
  Calls:
  MySql Database
   
...
class PaymentsHeaderHistoryList extends gridDataSource{
    public $tableName = "paymentsheaderhistory";
    ...
    public function getDetail($id){
        ...
        $result = DB::select("SELECT " . implode(",", $fields) . " from paymentsdetailhistory " .  ( $keyFields != "" ? " WHERE ". $keyFields : ""), array());
    ...
    public function detailDelete(){
        ...
        DB::delete("DELETE from paymentsdetailhistory " .   ( $keyFields != "" ? " WHERE ". $keyFields : ""));
    }
}
?>
