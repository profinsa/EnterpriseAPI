...
class gridData extends gridDataSource{
    ...
    public $dashboardTitle ="Payments History";
    public $breadCrumbTitle ="Payments History";
    ...
    public $detailTable = [
        "viewPath" => "AccountsPayable/VoucherProcessing/ViewVouchersHistoryDetail",
    ...
    public function getDetail($id){
        ...
        $result = $GLOBALS["DB"]::select("SELECT " . implode(",", $fields) . " from paymentsdetailhistory " .  ( $keyFields != "" ? " WHERE ". $keyFields : ""), array());
    ...
    public function detailDelete(){
        ...
        $GLOBALS["DB"]::delete("DELETE from paymentsdetailhistory " .   ( $keyFields != "" ? " WHERE ". $keyFields : ""));
    }
}
?>
