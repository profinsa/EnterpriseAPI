<?php
/*
  Name of Page: ServiceOrderHeaderClosedList model
   
  Method: Model for www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\ServiceProcessing\ServiceOrderHeaderClosedList.php It provides data from database and default values, column names and categories
   
  Date created: 02/16/2017  Kenna Fetterman
   
  Use: this model used by views/ServiceOrderHeaderClosedList for:
  ...
   
  Called from:
  created and used for ajax requests by controllers/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\ServiceProcessing\ServiceOrderHeaderClosedList.php
  used as model by views/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\ServiceProcessing\ServiceOrderHeaderClosedList.php
   
  Calls:
  MySql Database
   
...
class gridData extends gridDataSource{
	...
	protected $gridConditions = "(LOWER(IFNULL(OrderHeader.TransactionTypeID,N''))='service order') AND (OrderHeader.Invoiced = 1)";	
