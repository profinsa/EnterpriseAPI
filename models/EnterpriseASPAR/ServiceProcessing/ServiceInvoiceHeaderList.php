<?php
/*
  Name of Page: ServiceInvoiceHeaderList model
   
  Method: Model for www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\ServiceProcessing\ServiceInvoiceHeaderList.php It provides data from database and default values, column names and categories
   
  Date created: 02/16/2017  Kenna Fetterman
   
  Use: this model used by views/ServiceInvoiceHeaderList for:
  ...
   
  Called from:
  created and used for ajax requests by controllers/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\ServiceProcessing\ServiceInvoiceHeaderList.php
  used as model by views/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\ServiceProcessing\ServiceInvoiceHeaderList.php
   
  Calls:
  MySql Database
   
...
class gridData extends gridDataSource{
    ...
    public function Post(){
        $user = Session::get("user");
         ...
         DB::statement("CALL ServiceInvoice_Post2('" . $user["CompanyID"] . "','" . $user["DivisionID"] . "','" . $user["DepartmentID"] . "','" . $_POST["InvoiceNumber"] . "',@PostingResult,@SWP_RET_VALUE)");
