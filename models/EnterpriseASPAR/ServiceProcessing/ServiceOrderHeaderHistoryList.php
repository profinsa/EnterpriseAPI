<?php
/*
  Name of Page: ServiceOrderHeaderHistoryList model
   
  Method: Model for www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\ServiceProcessing\ServiceOrderHeaderHistoryList.php It provides data from database and default values, column names and categories
   
  Date created: 02/16/2017  Kenna Fetterman
   
  Use: this model used by views/ServiceOrderHeaderHistoryList for:
  ...
   
  Called from:
  created and used for ajax requests by controllers/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\ServiceProcessing\ServiceOrderHeaderHistoryList.php
  used as model by views/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\ServiceProcessing\ServiceOrderHeaderHistoryList.php
   
  Calls:
  MySql Database
   
...
class gridData extends gridDataSource{
    ...
    public function detailDelete(){
        ...
        DB::delete("DELETE from orderdetailhistory " .   ( $keyFields != "" ? " WHERE ". $keyFields : ""));
    }
}
?>
