<?php
/*
  Name of Page: ServiceInvoiceHeaderClosedList model
   
  Method: Model for www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\ServiceProcessing\ServiceInvoiceHeaderClosedList.php It provides data from database and default values, column names and categories
   
  Date created: 02/16/2017  Kenna Fetterman
   
  Use: this model used by views/ServiceInvoiceHeaderClosedList for:
...
class gridData extends gridDataSource{
    ...
    //	protected $gridConditions = "((LOWER(IFNULL(InvoiceHeader.TransactionTypeID,N'')) ='service invoice') AND (Posted=1)  AND (ABS(InvoiceHeader.BalanceDue) < 0.005) AND (ABS(InvoiceHeader.Total) >= 0.005))";
    protected $gridConditions = "((LOWER(IFNULL(InvoiceHeader.TransactionTypeID,N'')) ='service invoice') AND (Posted=1))";
