<?php
/*
  Name of Page: RMA History Detail model

  Method: Model for RMA History Detail form. It provides data from database and default values, column names and categories
...
class RMAHistoryDetail extends gridDataSource{
	public $tableName = "purchasedetailhistory";
	...
	public $dashboardTitle ="RMA History Detail";
	public $breadCrumbTitle ="RMA History Detail";
