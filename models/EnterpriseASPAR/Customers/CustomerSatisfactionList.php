...
/*
  ...
   
  Method: Model for www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\Customers\CustomerSatisfactionList.php It provides data from database and default values, column names and categories
   
  ...
   
  Called from:
  created and used for ajax requests by controllers/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\Customers\CustomerSatisfactionList.php
  used as model by views/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\Customers\CustomerSatisfactionList.php
   
  Calls:
  MySql Database
   
...
class CustomerSatisfactionList extends gridDataSource{
    public $tableName = "customersatisfaction";
    ...
    public $columnNames = [
        ...
        "QuestionSevenMetric" => "Question SevenMetric",
