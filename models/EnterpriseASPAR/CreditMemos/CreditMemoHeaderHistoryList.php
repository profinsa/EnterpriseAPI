...
class CreditMemoHeaderHistoryList extends gridDataSource{
    public $tableName = "invoiceheaderhistory";
    public $gridConditions = "(LOWER(InvoiceHeaderHistory.TransactionTypeID) IN ('credit memo'))";
    public $dashboardTitle ="Credit Memos History";
    public $breadCrumbTitle ="Credit Memos History";
    public $docType = "creditmemohistory";
    ...
    public $detailTable = [
        "disableNew" => "true",
        "viewPath" => "AccountsReceivable/CreditMemos/ViewCreditMemoHistoryDetail",
    ...
    public function getCustomers(){
        ...
        $result = DB::select("SELECT * from customerinformation " .  ( $keyFields != "" ? " WHERE ". $keyFields : ""), array());
