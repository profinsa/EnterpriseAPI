<?php
/*
  Name of Page: CreditMemoHeaderClosedList model
   
  Method: Model for www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\CreditMemos\CreditMemoHeaderClosedList.php It provides data from database and default values, column names and categories
   
  Date created: 02/16/2017  Kenna Fetterman
   
  Use: this model used by views/CreditMemoHeaderClosedList for:
  ...
   
  Called from:
  created and used for ajax requests by controllers/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\CreditMemos\CreditMemoHeaderClosedList.php
  used as model by views/www.integralaccountingx.com\NewTechPhp\app\Http\Models\EnterpriseASPAR\CreditMemos\CreditMemoHeaderClosedList.php
   
  Calls:
  MySql Database
   
...
class gridData extends gridDataSource{
    ...
    public $headTableOne = [
        "Credit Memo Number" => "InvoiceNumber",
        "Credit Memo Date" => "InvoiceDate",
    ...
    public $detailTable = [
        "viewPath" => "AccountsReceivable/CreditMemos/ViewCreditMemosDetail",
    ...
    public function detailDelete(){
        ...
        DB::delete("DELETE from invoicedetail " .   ( $keyFields != "" ? " WHERE ". $keyFields : ""));
    }

    public function Recalc(){
        $recalc = new recalcHelper;

        $recalc->creditMemoRecalc(Session::get("user"), $_POST["InvoiceNumber"]);
    ...
    public function Post(){
        $user = Session::get("user");
         ...
         DB::statement("CALL CreditMemo_Post('" . $user["CompanyID"] . "','" . $user["DivisionID"] . "','" . $user["DepartmentID"] . "','" . $_POST["InvoiceNumber"] . "',@PostingResult,@SWP_RET_VALUE)");
    ...
    public function CopyToHistory(){
        ...
        foreach($numbers as $number){
            DB::statement("CALL CreditMemo_CopyToHistory2('" . $user["CompanyID"] . "','" . $user["DivisionID"] . "','" . $user["DepartmentID"] . "','" . $number . "',@SWP_RET_VALUE)");
    ...
    public function CopyAllToHistory(){
        ...
        DB::statement("CALL CreditMemo_CopyAllToHistory('" . $user["CompanyID"] . "','" . $user["DivisionID"] . "','" . $user["DepartmentID"] . "', @SWP_RET_VALUE)");
