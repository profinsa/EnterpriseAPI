...
/*
Name of Page: CreditMemoHeaderList model
 
Method: Model for www.integralaccountingx.com\EnterpriseX\models\EnterpriseASPAR\CreditMemos\CreditMemoHeaderList.php It provides data from database and default values, column names and categories
 
...
 
Called from:
created and used for ajax requests by controllers/www.integralaccountingx.com\EnterpriseX\models\EnterpriseASPAR\CreditMemos\CreditMemoHeaderList.php
used as model by views/www.integralaccountingx.com\EnterpriseX\models\EnterpriseASPAR\CreditMemos\CreditMemoHeaderList.php
 
Calls:
MySql Database
 
...
class gridData extends gridDataSource{
    ...
    protected $gridConditions = "(ABS(InvoiceHeader.BalanceDue) >= 0.005 OR ABS(InvoiceHeader.Total) < 0.005 OR IFNULL(InvoiceHeader.Posted,0) = 0) AND (LOWER(InvoiceHeader.TransactionTypeID) IN ('credit memo'))";
    ...
    public function getDetail($id){
        ...
        $result = $GLOBALS["DB"]::select("SELECT " . implode(",", $fields) . " from invoicedetail " .  ( $keyFields != "" ? " WHERE ". $keyFields : ""), array());
    ...
    public function detailDelete(){
        ...
        $GLOBALS["DB"]::delete("DELETE from invoicedetail " .   ( $keyFields != "" ? " WHERE ". $keyFields : ""));
    }
}
?>
