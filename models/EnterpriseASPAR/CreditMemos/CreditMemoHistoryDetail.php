<?php
/*
  Name of Page: Invoice Detail History model

  Method: Model for Invoice Detail History form. It provides data from database and default values, column names and categories
...
class gridData extends gridDataSource{
	...
	public $dashboardTitle ="Credit Memo History Detail";
	public $breadCrumbTitle ="Credit Memo History Detail";
