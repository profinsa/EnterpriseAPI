...
class InventoryWorkOrderHeaderClosedList extends gridDataSource{
    ...
    public function getDetail($id){
        ...
        $result = $GLOBALS["DB"]::select("SELECT " . implode(",", $fields) . " from workorderdetail " .  ( $keyFields != "" ? " WHERE ". $keyFields : ""), array());
