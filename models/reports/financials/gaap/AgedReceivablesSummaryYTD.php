<?php
/*
Name of Page: doc financials gaap aged receivables summary YTD data source
...
class financialsReportData{
    ...
    public $title = "GAAP Aged Receivables Summary YTD Report";
    ...
    public function getData(){
        ...
        $stmt = $conn->prepare("CALL RptGLAgedReceivablesDetailYTD('" . $user["CompanyID"] . "', '" . $user["DivisionID"] . "', '" . $user["DepartmentID"] . "', @ret)",array($conn::MYSQL_ATTR_USE_BUFFERED_QUERY => true));
