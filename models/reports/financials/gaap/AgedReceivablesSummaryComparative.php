<?php
/*
Name of Page: doc financials gaap aged receivables summary comparative data source

Method: It provides data from database for financial report page
...
class financialsReportData{
    ...
    public $title = "GAAP Aged Receivables Summary Comparative Report";
    ...
    public function getData(){
        ...
        $stmt = $conn->prepare("CALL RptGLAgedReceivablesDetailComparative('" . $user["CompanyID"] . "', '" . $user["DivisionID"] . "', '" . $user["DepartmentID"] . "', @ret)",array($conn::MYSQL_ATTR_USE_BUFFERED_QUERY => true));
