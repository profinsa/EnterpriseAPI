...
class docReportsData{
    ...
    public function getCurrencySymbol(){
        ...
        $result =  DB::select("select I.CurrencyID, C.CurrenycySymbol from OrderHeaderHistory I, CurrencyTypes C WHERE I.CurrencyID=C.CurrencyID and I.OrderNumber='" . $this->id . "' and I.CompanyID='" . $user["CompanyID"] . "' and I.DivisionID='" . $user["DivisionID"] . "' and I.DepartmentID='" . $user["DepartmentID"] . "'", array());
