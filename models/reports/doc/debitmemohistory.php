<?php
/*
   Name of Page: doc reports debitmemohistory data source
...
class docReportsData{
    ...
    public function getCurrencySymbol(){
        ...
        $result =  DB::select("select I.CurrencyID, C.CurrenycySymbol from PurchaseHeaderHistory I, CurrencyTypes C WHERE I.CurrencyID=C.CurrencyID and I.PurchaseNumber='" . $this->id . "' and I.CompanyID='" . $user["CompanyID"] . "' and I.DivisionID='" . $user["DivisionID"] . "' and I.DepartmentID='" . $user["DepartmentID"] . "'", array());
    ...
    public function getHeaderData(){
        ...
        $stmt = $conn->prepare("CALL RptDocDebitMemoHeaderHistorySingle('". $user["CompanyID"] . "','". $user["DivisionID"] ."','" . $user["DepartmentID"] . "', '" . $this->id . "')");
        $rs = $stmt->execute();
    ...
    public function getDetailData(){
        ...
        $conn =  DB::connection()->getPdo();
        $stmt = $conn->prepare("CALL RptDocDebitMemoDetailHistorySingle('". $user["CompanyID"] . "','". $user["DivisionID"] ."','" . $user["DepartmentID"] . "', '" . $this->id . "')");
        $rs = $stmt->execute();
        $result = $stmt->fetchAll($conn::FETCH_ASSOC);
